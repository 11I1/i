...
insertCommand("skill", function(getPlayer)
    if game.PlaceId == 1662219031 then
        ...
        local clock = os.time()
        repeat task.wait(); if (os.time() - clock) >= 5 then plr.Character.Humanoid:ChangeState(15) end until getPlayer.Character.Humanoid.Health <= 0
...
insertCommand("as", function(getPlayer)
    if game.PlaceId == 1662219031 then
        ...
        local clock = os.time()
        repeat task.wait(); if (os.time() - clock) >= 5 then plr.Character.Humanoid:ChangeState(15) end until getPlayer.Character:FindFirstChild("Sitting")
        plr.Character.Humanoid:ChangeState(15)
    end
end)
