...
insertCommand("lskill", function(getPlayer)
    ...
    loops.lskill = true
    while loops.lskill do pcall(api.cmds[api.prefix.new.."skill"](getPlayer)); plr.CharacterAdded:Wait(0.85); repeat task.wait() until loops.lskill and plr.Character:FindFirstChild("HumanoidRootPart") end
end)

insertCommand("lskill2", function(getPlayer)
    api.cmds[api.prefix.new.."stop"]()
    loops.lskill2 = true
    while loops.lskill2 do pcall(api.cmds[api.prefix.new.."skill2"](getPlayer)); plr.CharacterAdded:Wait(0.85); repeat task.wait() until loops.lskill2 and plr.Character:FindFirstChild("HumanoidRootPart") end
end)
