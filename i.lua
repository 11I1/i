...
insertCommand("svoid", function(getPlayer)
    ...
    plr.Character:PivotTo(plr.Character:GetModelCFrame() * CFrame.new(0, -485, 0)); wait(1/4)
    local clock = os.time()
    ...
    plr.Character:PivotTo(CFrame.new(0, workspace.FallenPartsDestroyHeight, 0)); task.wait(1/4)
