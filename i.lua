...
insertCommand("lskill", function(getPlayer)
    ...
    loops.lskill = true
    while loops.lskill do api.cmds[api.prefix.new.."skill"](getPlayer); plr.CharacterAdded:WaitForChild("Humanoid") end
...
insertCommand("lskill2", function(getPlayer)
    api.cmds[api.prefix.new.."stop"]()
    loops.lskill2 = true
    while loops.lskill2 do api.cmds[api.prefix.new.."skill2"](getPlayer); plr.CharacterAdded:WaitForChild("Humanoid") end
    rs.Heartbeat:Wait(1/4)
end)
