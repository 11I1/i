...
insertCommand("svoid", function(getPlayer)
    ...
    plr.Character:PivotTo(CFrame.new(0, workspace.FallenPartsDestroyHeight, 0)); rs.RenderStepped:Wait(1)
    tool.Parent, wand.Parent = plr.Character, plr.Character; rs.RenderStepped:Wait(1)
    tool.Parent, wand.Parent = workspace, workspace; rs.RenderStepped:Wait(1)
    firetouchinterest(getPlayer.Character.PrimaryPart, tool.Handle, 0); rs.RenderStepped:Wait(1)
    firetouchinterest(getPlayer.Character.PrimaryPart, wand.Handle, 0)
