    ...
    local function run(clock)
        ...
        spawn(function()
            repeat
                ...
                firetouchinterest(getPlayer.Character.PrimaryPart, tool.Handle, 0, task.wait(), firetouchinterest(getPlayer.Character.PrimaryPart, workspace:FindFirstChild(wand).Handle, 0))
            until wand.Parent = getPlayer.Character
        end)

        wand.Parent, wand.Parent = plr.Character, workspace
        firetouchinterest(getPlayer.Character.PrimaryPart, workspace:FindFirstChild(wand).Handle, 0)
