...
insertCommand("lskill", function(getPlayer)
    loops["lskill"] = true
    while loops["lskill"] do task.spawn(function() api.cmds[api["prefix"]["new"].."skill"](getPlayer) end); plr.CharacterAdded:WaitForChild("ForceField") end
end)

insertCommand("lskill2", function(getPlayer)
    loops["lskill2"] = true
    while loops["lskill2"] do task.spawn(function() api.cmds[api["prefix"]["new"].."skill2"](getPlayer) end); plr.CharacterAdded:WaitForChild("ForceField") end
end)
